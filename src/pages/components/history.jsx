              ...
              <div className="w-[calc(50%-20px)] px-2">
                ...
                {entry.items.map((item, i) => (
                  <div key={i} className="mb-1 group transition-all duration-300">
                    ...
                    <div className="bg-white border border-gray-300 shadow-sm p-1.5 text-xs leading-tight rounded-md  /* ✅ text-[10px] -> text-xs로 변경 */
                    group-hover:bg-[#004A91] group-hover:text-white group-hover:scale-[1.03] transform transition duration-300">
                      <span>
...
export default function HistoryTimeline() {
  return (
    <section
      id="history"
      className="snap-start min-h-screen pt-24 pb-12 px-4 bg-gradient-to-br from-gray-400 to-white"
    >
